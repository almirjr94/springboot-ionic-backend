...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente("Maria Silva","maria@gmail.com","44215316855", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","9388393"));
		
		Cliente cli2 = new Cliente("Ana Silva","mariaa@gmail.com","05550223074", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("27356546","93885455"));
		...
		Endereco e3 = new Endereco("Avendida Brasil", "1545", null, "Centro", "38787012",cli2,c2);
